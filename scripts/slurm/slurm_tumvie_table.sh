...
set -eo pipefail
# Note : TUM-VIE est à 720x1280, les séquences sont longues → 12h et 64G RAM.

REPO_DEVO=${REPO_DEVO:-/home/i/i0002573/arthur_ipal/DEVO}
MS_MODEL=${MS_MODEL:-/home/i/i0002573/arthur_ipal/MS_Model}
DATAPATH=${DATAPATH:-/home/i/i0002573/arthur_ipal/datasets/tumvie}
DEVO_WEIGHTS=${DEVO_WEIGHTS:-/home/i/i0002573/test_perso/DEVO/DEVO.pth}
VAL_SPLIT=${VAL_SPLIT:-splits/tumvie/tumvie_val.txt}
...
SEED=${SEED:-1234}
OUTDIR=${OUTDIR:-results/tumvie_central_table}
...
python -u evals/eval_evs/eval_tumvie_central_table.py \
    --datapath "$DATAPATH" \
