#!/bin/bash
# M3 EVIMO2+SfM scratch — entraînement couplé auto-supervisé sans poids MS Model pré-entraînés.
#SBATCH --job-name=m3_evimo2_sfm_scratch
...
OUTDIR=${OUTDIR:-results_coupled/m3_evimo2_sfm_scratch}
