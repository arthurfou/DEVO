#!/bin/bash
# M3-scratch — entraînement COUPLÉ auto-supervisé (sans GT) avec MS initialisé ALÉATOIREMENT.
# Prior doux β·(mask_mean − 0.1)² essentiel pour éviter le collapse (mask→0 ou 1).
# 10k freeze + 40k total.
#SBATCH --job-name=m3_scratch
...
OUTDIR=${OUTDIR:-results_coupled/m3_scratch}
# ================
