#!/bin/bash
# M2 EVIMO2 scratch — couplé supervisé, MS initialisé aléatoirement + prior anti-collapse.
#SBATCH --job-name=m2_evimo2_scratch
...
OUTDIR=${OUTDIR:-results_coupled/m2_evimo2_scratch}
