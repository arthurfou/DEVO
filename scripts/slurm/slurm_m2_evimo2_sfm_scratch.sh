#!/bin/bash
# M2 EVIMO2+SfM scratch — entraînement couplé supervisé sans poids MS Model pré-entraînés.
#SBATCH --job-name=m2_evimo2_sfm_scratch
...
OUTDIR=${OUTDIR:-results_coupled/m2_evimo2_sfm_scratch}
