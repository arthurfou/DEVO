...
DATAPATH=${DATAPATH:-/home/i/i0002573/arthur_ipal/datasets/fpv}
DEVO_WEIGHTS=${DEVO_WEIGHTS:-/home/i/i0002573/test_perso/DEVO/DEVO.pth}
VAL_SPLIT=${VAL_SPLIT:-splits/fpv/fpv_val.txt}
...
SEED=${SEED:-1234}
OUTDIR=${OUTDIR:-results/fpv_central_table}
...
python -u evals/eval_evs/eval_fpv_central_table.py \
    --datapath "$DATAPATH" \
